...
function university_files() {
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDHp811R_f6wQQyYlYwJ-LHxofQXylHQKA', NULL, '1.0', true);
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyDHp811R_f6wQQyYlYwJ-LHxofQXylHQKA';
    return $api;
}
